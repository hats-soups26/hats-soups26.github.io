...
- **Lorin Schöni** — ETH Zurich
- **Alexandra von Preuschen** — CISPA
- **Neele Roch** — ETH Zurich
- **Tarini Saka** — Max Planck Institute for Security and Privacy (MPI-SP)
- **Luisa Jansen** — University of Bern
- **Adrienn Toth** — ETH Zurich
- **Marlene Wagner** — ETH Zurich
- **Steffen Holter** — ETH Zurich
