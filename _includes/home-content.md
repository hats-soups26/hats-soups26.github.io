<div class="py-6 px-3 mb-5 text-center rounded-3 hero-panel">
  <div class="hero-nav-top">
    <a class="hero-brand" href="/" aria-label="HATS Workshop home">
      <img src="/hats_v0.png" alt="HATS Workshop logo">
    </a>
    <nav class="hero-nav" aria-label="Primary">
      <a href="/" aria-current="page">Home</a>
      <a href="{{ '/accepted-papers.html' | relative_url }}">Accepted Papers</a>
    </nav>
  </div>
...
<section class="content-section section-green" markdown="1">
...
- **Part 1: Shared context** — Welcome, introductions, and lightning paper talks
- **Break** — Short break between parts
- **Part 2: Collaborative design** — Small-group co-design, vernissage-style sharing, and plenary discussion
